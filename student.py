...
class Student:
    ...
    # This part is image labels setting start 
        ...
        dep_combo["values"]=("Select Department","CS","IT","AT")
        dep_combo.current(0)
        ...
        cou_combo["values"]=("Select Course","MLP","GD","ORACLE","MAD")
        cou_combo.current(0)
        ...
        year_combo["values"]=("Select Year","2011","2012","2013","2014","2015","2016","2017","2018","2019","2020","2021","2022","2023")
        ...
        #label Semester 
        year_label=Label(current_course_frame,text="Month",font=("verdana",12,"bold"),bg="white",fg="navyblue")
        ...
        year_combo["values"]=("Select Month","Month-1","Month-2","Month-3","Month-4","Month-5","Project Level")
        year_combo.current(0)
        ...
        #Teacher Name
        student_teacher_label = Label(class_Student_frame,text="Teacher Name:",font=("verdana",12,"bold"),fg="navyblue",bg="white")
        ...
        #save button
        save_btn=Button(btn_frame,command=self.add_data,text="Save",width=7,font=("verdana",12,"bold"),bg="darkgreen",fg="white")
        save_btn.grid(row=0,column=0,padx=5,pady=10,sticky=W)

        #update button
        update_btn=Button(btn_frame,command=self.update_data,text="Update",width=7,font=("verdana",12,"bold"),bg="darkgreen",fg="white")
        update_btn.grid(row=0,column=1,padx=5,pady=8,sticky=W)

        #delete button
        del_btn=Button(btn_frame,command=self.delete_data,text="Delete",width=7,font=("verdana",12,"bold"),bg="darkgreen",fg="white")
        del_btn.grid(row=0,column=2,padx=5,pady=10,sticky=W)

        #reset button
        reset_btn=Button(btn_frame,command=self.reset_data,text="Reset",width=7,font=("verdana",12,"bold"),bg="darkgreen",fg="white")
        reset_btn.grid(row=0,column=3,padx=5,pady=10,sticky=W)

        #take photo button
        take_photo_btn=Button(btn_frame,command=self.generate_dataset,text="Take Pic",width=9,font=("verdana",12,"bold"),bg="darkgreen",fg="white")
        take_photo_btn.grid(row=0,column=4,padx=5,pady=10,sticky=W)

        #update photo button
        update_photo_btn=Button(btn_frame,command=self.generate_dataset,text="Update Pic",width=9,font=("verdana",12,"bold"),bg="darkgreen",fg="white")
        ...
        search_btn=Button(search_frame,command=self.search_data,text="Search",width=9,font=("verdana",12,"bold"),bg="darkgreen",fg="white")
        search_btn.grid(row=0,column=3,padx=5,pady=10,sticky=W)

        showAll_btn=Button(search_frame,command=self.fetch_data,text="Show All",width=8,font=("verdana",12,"bold"),bg="darkgreen",fg="white")
